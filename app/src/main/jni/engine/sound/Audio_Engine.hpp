...
public:
    ...
    static int play_sound(Sound_Sample *sound, Entity *ent, Vec3 pos, int sound_priority,
                          float volume);

    int play_sound_sample(Sound_Sample *sound, Entity *ent, Vec3 pos, int sound_priority,
                          float volume);
