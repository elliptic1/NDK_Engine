...
int Cube_Map::init_gl() {
    ...
    glCompressedTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X, 0, ETC1_RGB8, width, height, 0,
                           raw_data_p_x_length, (const void *) raw_data_pos_x);
    glCompressedTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_X, 0, ETC1_RGB8, width, height, 0,
                           raw_data_n_x_length, (const void *) raw_data_neg_x);
    glCompressedTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_Y, 0, ETC1_RGB8, width, height, 0,
                           raw_data_p_y_length, (const void *) raw_data_pos_y);
    glCompressedTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_Y, 0, ETC1_RGB8, width, height, 0,
                           raw_data_n_y_length, (const void *) raw_data_neg_y);
    glCompressedTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_Z, 0, ETC1_RGB8, width, height, 0,
                           raw_data_p_z_length, (const void *) raw_data_pos_z);
    glCompressedTexImage2D(GL_TEXTURE_CUBE_MAP_NEGATIVE_Z, 0, ETC1_RGB8, width, height, 0,
                           raw_data_n_z_length, (const void *) raw_data_neg_z);
